    ...
    <nav class="main-nav">
      <ul class="nav-list">
        <li class="nav-list-item">
          <router-link to="/home" class="nav-list-link">Home</router-link>
        </li>
        <li class="nav-list-item">
          <router-link to="/about" class="nav-list-link">About</router-link>
        </li>
        <li class="nav-list-item">
          <router-link to="/projects" class="nav-list-link">Projects</router-link>
        </li>
        <li class="nav-list-item">
          <router-link to="/blog" class="nav-list-link">Blog</router-link>
        </li>
        <li class="nav-list-item">
          <router-link to="/contact" class="nav-list-link">Contact</router-link>
        </li>
      </ul>
    </nav>
  </div>
